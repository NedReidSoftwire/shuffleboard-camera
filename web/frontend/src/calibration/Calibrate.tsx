    ...
    return (
        <div className="w-full">
            <div className="flex">
                ...
                <button className="font-bold text-2xl p-4 text-center bg-purple-300 hover:bg-purple-500" onClick={addCorner}>
                    Confirm
                </button>
            </div>
            <Stage
                ...
                onClick={(event) => {
                    ...
                    if (stage && pointer) {
                        ...
                        setCurrentCorner([(pointer.x - stage.x()) / oldScale, (pointer.y - stage.y()) / oldScale])
                ...
                onWheel={(event) => {
                    ...
                    if (stage && pointer) {
                        ...
                        const newScale = Math.max(direction > 0 ? oldScale * scaleBy : oldScale / scaleBy, 1);
            ...
            >
                ...
                <Layer>
                    <Circle x={currentCorner[0]} y={currentCorner[1]} stroke="red" radius={1} strokeWidth={0.5}/>
